...
const Coursecard = (props) => {
    return (
        <div className='flex flex-col justify-between bg-white border-2 border-lightText md:border-none md:w-2/5 p-5 cursor-pointer rounded-lg hover:shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] transition-all'>
            <div className='w-full w-3/5'>
                <img src={props.image} alt="Course Card" />
            </div>
            <div>
                <h3 className='font-bold text-lg text-center my-5'>{props.title}</h3>
